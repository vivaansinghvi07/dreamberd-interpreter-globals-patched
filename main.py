...
And does the following:
    ...
    2) Create a file in the `serialized_objects` directory with the name of the ID and the information in the variable
"""
import re
import os 
import random
...
if __name__ == "__main__":
    ...
    value_id = -1
    while value_id < 0 or value_id in os.listdir("serialized_objects"):
        value_id = random.randint(1, 1000000000)

    with open(f"./serialized_objects/{value_id}", 'w') as f:
        f.write(ISSUE_BODY)
